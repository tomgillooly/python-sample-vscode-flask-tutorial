[![Build Status](https://dev.azure.com/tomgillooly/prac_ml_ops/_apis/build/status/tomgillooly.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/tomgillooly/prac_ml_ops/_build/latest?definitionId=1&branchName=master)
